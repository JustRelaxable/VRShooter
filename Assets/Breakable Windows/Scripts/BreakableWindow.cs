...
public class BreakableWindow : MonoBehaviour {
    ...
    private void generateSingleSplinter(int[] tris, Transform parent)
    {
        ...
        //obj.transform.localScale = new Vector3(parçaSize,parçaSize,parçaSize);
    ...
    public GameObject[] breakWindow()
    {
        ...
        for (int i = 0; i < splinters.Count; i++)
        {
            splinters[i].transform.localScale = new Vector3(parçaSize, parçaSize, parçaSize);
        }
    ...
    {
        if(col.gameObject.layer == LayerMask.NameToLayer("Ok"))
        {
