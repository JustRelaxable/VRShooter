...
public class OVRControllerHelper : MonoBehaviour
{
	...
	void Update()
	{
		...
		{
			//If controller not connected then let's just simulate its model because we are poor...
			...
			switch (m_controller)
			{
				...
				case OVRInput.Controller.LTouch:
					m_modelOculusTouchRiftLeftController.SetActive(true);
					break;
				case OVRInput.Controller.RTouch:
					m_modelOculusTouchRiftRightController.SetActive(true);
					break;
